<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="404.aspx.cs" Inherits="Dear_Diary.Errors._404" %>
...
<html>
  ...
  @media screen and (max-width: 450px) {
    ...
    .background-image {
      ...
      background-image: url(http://www.iglou.com/wp-content/uploads/2012/10/photodune-2392898-server-m.jpg) !important;
    }
  ...
  <div class="content-container shadow">
    ...
    <div class="subheader primary-text-color">
      GG, the page you're looking for has either ran away or died. Or both.
    </div>
    <div class="hr"></div>
    <div class="context secondary-text-color">
      <p>
        You may want to head back to our homepage. If you think something is broken, report a problem. We promise we didn't kill any webpages.
      </p>
    </div>
    <div class="buttons-container">
      <a class="button" href="/Default.aspx" target="_blank"><span class="fa fa-home"></span> Go To Homepage</a>
      <a class="button" href="mailto:155126N@mymail.nyp.edu.sg" target="_blank"><span class="fa fa-warning"></span> Report A Problem</a>
    </div>
  </div>
</center>
